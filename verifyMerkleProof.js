// This is https://github.com/bitcoin-sv-specs/merkle-proof-standard-example/blob/abc0b04810c945d00b4e0bba8c7339360b4c2ad6/verifyMerkleProofJSON.js
// It is the reference implementation verifier.
...
function getMerkleTreeParent (leftNode, rightNode) {
  ...
  const result = swapEndianness(Buffer.from(hash, 'hex')).toString('hex')
  return result
}
